                                             ...
                                             {log.changes ? Object.entries(log.changes).map(([field, delta]: any) => (
                                                <div key={field} className="grid grid-cols-1 md:grid-cols-12 gap-3 border-b border-border/10 pb-3 last:border-0 last:pb-0">
                                                   ...
                                                   <div className="md:col-span-9 flex flex-wrap items-center gap-2">
                                                      <span className="px-2 py-0.5 rounded bg-rose-500/5 text-rose-600 line-through decoration-rose-600/30">{delta.old !== undefined && delta.old !== null ? String(delta.old) : "—"}</span>
                                                      <ArrowRight className="h-3 w-3 opacity-30" />
                                                      <span className="px-2 py-0.5 rounded bg-emerald-500/5 text-emerald-600 font-bold">{delta.new !== undefined && delta.new !== null ? String(delta.new) : "—"}</span>
                                                   </div>
                                                </div>
                                             )) : (
