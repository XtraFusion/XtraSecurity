...
const mockRules: NotificationRule[] = [
  ...
  {
    id: "2",
    name: "Failed Rotations",
    description: "Alert when secret rotation fails",
    enabled: true,
    triggers: ["rotation_failed"],
    ...
    lastTriggered: "2024-01-13T14:20:00Z",
  },
  {
    id: "3",
    name: "Suspicious Activity",
    description: "Alert on suspicious access patterns or unauthorized attempts",
    enabled: true,
    triggers: ["suspicious_activity", "access_denied"],
    channels: ["slack-1", "teams-1"],
    conditions: {
      severity: ["warning", "error", "critical"],
    },
...
const mockChannels: NotificationChannel[] = [
  ...
  },
  {
    ...
    enabled: true,
    config: {
      webhookUrl: "https://events.pagerduty.com/integration/...",
    },
    createdAt: "2024-01-03T00:00:00Z",
  },
]
...
const mockAlerts: NotificationAlert[] = [
  ...
  },
  {
    id: "2",
    ruleId: "2",
    ruleName: "Failed Rotations",
    title: "Secret Rotation Failed",
    message: "Failed to rotate API_SECRET_KEY: Webhook endpoint returned 500 error",
    severity: "error",
  ...
  },
  {
    ...
    message: "5 failed login attempts from IP 192.168.1.100 in the last 10 minutes",
    severity: "critical",
...
export default function NotificationsPage() {
  ...
  const handleCreateRule = () => {
    if (!newRule.name || !newRule.triggers.length || !newRule.channels.length) return
                  ...
                  {newChannel.type === "email" && (
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setNewChannel({ ...newChannel, config: { ...newChannel.config, email: e.target.value } })
                        }
                      />
                    </div>
                  )}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setNewChannel({
                            ...newChannel,
                            config: { ...newChannel.config, teamsWebhook: e.target.value },
                          })
                        }
                      />
                    </div>
                  ...
                  {newChannel.type === "webhook" && (
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setNewChannel({ ...newChannel, config: { ...newChannel.config, webhookUrl: e.target.value } })
                        }
                      />
                    </div>
                  )}
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {["secret_change", "rotation_failed", "suspicious_activity", "access_denied", "system_error"].map(
                        (trigger) => (
                ...
                {filteredAlerts.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    <div className="text-muted-foreground">
                      {searchQuery ? "No alerts found matching your search." : "No alerts available."}
                    </div>
                  </div>
                )}
              </CardContent>
