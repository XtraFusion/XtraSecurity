...
func (r ApiGetAuditLogsRequest) WorkspaceId(workspaceId string) ApiGetAuditLogsRequest {
...
//  @return []AuditLog
func (a *AuditAPIService) GetAuditLogsExecute(r ApiGetAuditLogsRequest) ([]AuditLog, *http.Response, error) {
	var (
